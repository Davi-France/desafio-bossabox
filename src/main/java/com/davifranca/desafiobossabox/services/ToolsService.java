package com.davifranca.desafiobossabox.services;
...
public class ToolsService {
    ...
    public List<Tools> findToolByTag(List<String> tags){
        List<Tools> toolsList = toolsRepository.buscar(tags.toString());
        return toolsList;
    }
